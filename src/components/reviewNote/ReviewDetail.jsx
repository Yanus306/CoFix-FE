      ...
      <div className="flex flex-col gap-[1.2vh] mt-[0.2vh]">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-[0.6vw]">
            <button className="px-[0.9vw] py-[0.5vh] rounded-xl bg-red500/10 text-red400 text-[1.4vh] transition-all border border-solid border-red-500/20 cursor-pointer hover:bg-red500/20">
              취소
            </button>
            <button className="px-[0.9vw] py-[0.5vh] rounded-xl bg-purple500/10 text-purple400 text-[1.4vh] transition-all border border-solid border-purple500/20 cursor-pointer hover:bg-purple500/20">
              저장
            </button>
          </div>
        </div>
