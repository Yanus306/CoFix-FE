function CustomQuiz() {
    return (
        <div className="panel-base justify-center w-[37.86vw] h-[23.24vh] gap-[1.94vh]">
            ...
            <div className="flex justify-center items-center w-[7.86vw] h-[4.35vh] bg-purple500 text-[1.85vh] rounded-[1.04vw] font-bold text-gray200 cursor-pointer hover:bg-purple400 hover:text-gray700">퀴즈 풀기</div>
        </div>
    );
}
