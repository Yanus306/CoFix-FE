...
export default Create_account;import gitlogo from '../../assets/gitlogo.png';
import googlelogo from '../../assets/googlelogo.png';
import { Create_logic } from './Create_logic'; // 경로에 맞게 조정해 주세요
...
function Create_account({ isOpen1, onClose1, onSignUpComplete }) {
  const {
    ...
    handleGoogleLogin,
    handleGithubLogin,
  } = Create_logic({ onClose1, onSignUpComplete });
